...
"""
dict_results_empty = { 
    "run": None, "filenames": {}, "statistics": {}, "flag_error" : {},
...
def find_scaling(iteration_step, dict_results, other_parameters, simulated=False):
    ...
    for srun in srun_numbers:    
        ...
        # The error on the rates is just the statistical error: 
        # sqrt(counts) / Delta t / Delta I
