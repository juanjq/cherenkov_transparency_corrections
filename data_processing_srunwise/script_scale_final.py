...
def main(input_str):
    ...
    ####################################
    # Creating and storing configuration
    ...
    ##########################################
    # Filling the datacheck data to dictionary
    ...
    #######################################################
    # Scaling the needed subruns by the interpolated factor
